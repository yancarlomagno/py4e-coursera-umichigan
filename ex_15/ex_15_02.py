...
above for grading. If you run the program multiple times in testing or with
dfferent files, make sure to empty out the data before each run.
...
# Commit changes after they've finished to speed up and bc is not critical op.
conn.commit()

# Getting the top 10 results and displaying them
